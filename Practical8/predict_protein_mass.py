# define a function predicting protein mass
# > store the mass of each amino acid into a dictionary
# > start a loop 
# > if a supplied amino acid has no recorded mass reports an error
# > sum up the mass of every amino acids
